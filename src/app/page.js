        ...
        <div className="max-w-xl text-xl leading-7 text-stone-200 lg:max-w-lg text-justify">
          <ol role="list" className="text-stone-200 text-3xl">
            <li className="flex gap-x-3">
              <span>
                <strong className="font-semibold text-gray-100">
                  <a href="/subsystems/ADCS" className="hover:text-indigo-400 transition-all">
                    ADCS
                  </a>
                </strong>
              </span>
            ...
            <li className="flex gap-x-3">
              <span>
                <strong className="font-semibold text-gray-100">
                  <a href="/subsystems/ODHS" className="hover:text-indigo-400 transition-all">
                    ODHS
                  </a>
                </strong>
              </span>
            ...
            <li className="flex gap-x-3">
              <span>
                <strong className="font-semibold text-gray-100">
                  <a href="/subsystems/COMMS" className="hover:text-indigo-400 transition-all">
                    COMMS
                  </a>
                </strong>
              </span>
            ...
            <li className="flex gap-x-3">
              <span>
                <strong className="font-semibold text-gray-100">
                  <a href="/subsystems/PAYLOAD" className="hover:text-indigo-400 transition-all">
                    PAYLOAD
                  </a>
                </strong>
              </span>
            ...
            <li className="flex gap-x-3">
              <span>
                <strong className="font-semibold text-gray-100">
                  <a href="/subsystems/EPS" className="hover:text-indigo-400 transition-all">
                    EPS
                  </a>
                </strong>
              </span>
            ...
            <li className="flex gap-x-3">
              <span>
                <strong className="font-semibold text-gray-100">
                  <a href="/subsystems/STMS" className="hover:text-indigo-400 transition-all">
                    STMS
                  </a>
                </strong>
              </span>
          ...
          <p className="mt-8 font-black text-justify">
            <span className='bg-indigo-600 p-0.5 bg-clip-border'>
